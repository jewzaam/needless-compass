 ...
 * @author nmalik
 */
public abstract class AbstractRouteCommand extends HystrixCommand<org.jewzaam.needless.compass.model.Route> {

    private final List<double[]> coordinates;

    public AbstractRouteCommand(String groupKey, List<double[]> coordinates) {
